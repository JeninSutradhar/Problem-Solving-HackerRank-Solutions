...
int birthdayCakeCandles(int candles_count, int* candles) {
    // Step 1: Find the maximum height of Candles [Traversing the Array]
    // Variable to Store Maximun height of Candles
    int max_height = candles[0];

    // Iterate over to Calculate the Maximum height
    ...
    // Step 2: Count how many Candles have the maximum height
    int max_count = 0;
